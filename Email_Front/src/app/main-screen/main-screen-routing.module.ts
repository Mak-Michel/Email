...
const routes: Routes = [
  {
    ...
    children: [
      ...
      { path: 'trash/:function/:functionParameter', component: TrashComponent },
      { path: 'sent', component: SentComponent },
      { path: 'sent/:function/:functionParameter', component: SentComponent },
      { path: 'draft', component: DraftComponent },
      { path: 'draft/:function/:functionParameter', component: DraftComponent },
